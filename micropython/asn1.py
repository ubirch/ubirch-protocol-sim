# MIT License: https://github.com/getreu/asn1-tiny-decoder
# fixed for micropython by Matthias L. Jugel <matthias.jugel@ubirch.com>
...
def asn1_get_value_of_type(der, i, asn1_type):
    (ixs, ixf, ixl) = i
    asn1_type_table = {
...
# get value
def asn1_get_value(der, i):
    (ixs, ixf, ixl) = i
    return der[ixf:ixl + 1]


# get type+length+value
def asn1_get_all(der, i):
    (ixs, ixf, ixl) = i
